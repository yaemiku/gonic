...
| `GONIC_DEFAULT_MUSIC_PATH`                  | `-default-music-path`                  | default music path for when no folder is selected in client (useful for when client does not support choosing a folder)                                                                                                                                                                                                               |
